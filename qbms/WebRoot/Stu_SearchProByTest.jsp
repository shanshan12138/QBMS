    ...
    <table class="table">
      ...
      <tbody>
	    ...
	    <tr>
          <td>正确答案</td>
         <td>
 <script> var i=${pro.proAns}; if(i==1) { document.write('<button onclick="ans(this)" value="A" >查看答案</NOtton>');}
              </script>             
              
             <script> var i=${pro.proAns}; if(i==2) { document.write('<button onclick="ans(this)" value="B" >查看答案</NOtton>');}
              </script>
              
              <script> var i=${pro.proAns}; if(i==3) { document.write('<button onclick="ans(this)" value="C" >查看答案</NOtton>');}
              </script>
              
              <script> var i=${pro.proAns}; if(i==4) { document.write('<button onclick="ans(this)" value="D" >查看答案</NOtton>');}
              </script>
         </td>
        </tr>
		 <tr>
    ...
    <table class="table">
      ...
      <tbody>    
	    ...
	    <tr>
          <td>正确答案</td>
         <td>
         <script> var i=${pro.proAns}; if(i==1) { document.write('<button onclick="ans(this)" value="对" >查看答案</NOtton>');}
              </script>
              
         <script> var i=${pro.proAns}; if(i==-1) { document.write('<button onclick="ans(this)" value="错" >查看答案</NOtton>');}
              </script>
         </td>
        </tr>
		 <tr>
